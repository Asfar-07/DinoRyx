    ...
    <div className="ch-card group relative flex flex-col gap-3 p-4 rounded-2xl overflow-hidden">
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-3">
          <div className="ch-logo text-xl flex-shrink-0"
...
export default function ProfileDashboard() {
  ...
  return (
    <div className="root-wrap min-h-screen w-full p-4 mt-15 md:p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3.5">
              ...
              <div className="info-row">
                ...
                <div className="flex-1">
                  ...
                  {isEditing
                    ? <input {...register("address")}  className="ci w-full mt-1 h-[34px] text-sm" />
              ...
              <div className="info-row">
                ...
                <div className="flex-1">
                  ...
                  {isEditing
                    ? <input {...register("phone_no")}  className="ci w-full mt-1 h-[34px] text-sm" />
