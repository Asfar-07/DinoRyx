...
function HexagonBackground({
  ...
  return (
    <div
      ...
      className={cn(
        'relative size-full overflow-hidden dark:bg-neutral-900 bg-transparent',
        className,
      )}
      {...props}
    >
              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "after:content-[''] after:absolute after:inset-[var(--hexagon-margin)] dark:after:bg-neutral-950 after:bg-transparent",
                    'after:[clip-path:polygon(50%_0%,_100%_25%,_100%_75%,_50%_100%,_0%_75%,_0%_25%)]',
                    'hover:before:bg-neutral-200 dark:hover:before:bg-neutral-800 hover:before:opacity-100 hover:before:duration-0 dark:hover:after:bg-neutral-900 hover:after:bg-[#56b2bb] hover:after:opacity-100 hover:after:duration-0',
