  ...
  return (
    <section className="w-full bg-(--primary-bg-color) px-6 py-24 text-(--primary-text-color) md:px-10">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-5 text-base text-[#bac7cc] sm:text-sm">
          High-density data management wrapped in a premium, motivating
          interface.
        </p>
      </div>

      <div className="mx-auto mt-16 grid max-w-7xl grid-cols-1 gap-6 lg:grid-cols-5">
        {/* Trainer Network — large card */}
        <div className="flex flex-col rounded-2xl bg-[#1d2233]/60 p-8 ring-1 ring-white/5 lg:col-span-3">
        ...
        {/* Billing & Accounting */}
        <div className="flex flex-col rounded-2xl bg-[#1d2233]/60 p-8 ring-1 ring-white/5 lg:col-span-2">
        ...
        {/* Gym Discovery */}
        <div className="flex flex-col gap-8 rounded-2xl bg-[#1d2233]/60 p-8 ring-1 ring-white/5 lg:col-span-3 lg:flex-row lg:items-center">
